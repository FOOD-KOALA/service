...
public class TodoService {
    ...
    public List<TodoResponse> getTodosByUserEmail(@NonNull String email) throws EntityNotFoundException {
    ...
    public TodoResponse getTodoById(@NonNull String id) throws EntityNotFoundException {
    ...
    public TodoResponse createTodo(@NonNull CreateTodoRequest request) throws EntityNotFoundException {
    ...
    public TodoResponse setDone(@NonNull String id, boolean done) throws EntityNotFoundException {
    ...
    public TodoResponse assign(@NonNull String id, @NonNull AssignTodoRequest request) throws EntityNotFoundException {
        TodoEntity existing = getEntityById(id);
    ...
    public TodoResponse edit(@NonNull String id, @NonNull EditTodoRequest request) throws EntityNotFoundException {
        TodoEntity existing = getEntityById(id);
    ...
    public void deleteTodo(@NonNull String id) throws EntityNotFoundException {
    ...
    @NonNull
    private TodoEntity getEntityById(@NonNull String id) throws EntityNotFoundException {
        return todoRepository.findById(id)
                .orElseThrow(() -> new EntityNotFoundException(id));
    }

    @NonNull
    private TodoResponse toResponse(@NonNull TodoEntity todo, @NonNull UserEntity assignee) {
